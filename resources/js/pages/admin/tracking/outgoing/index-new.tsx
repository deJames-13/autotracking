...
import { type BreadcrumbItem, type PaginationData, type TrackOutgoing, type User } from '@/types';
...
const TrackingOutgoingIndex: React.FC<TrackingOutgoingIndexProps> = ({ completions, filterOptions }) => {
