...
export const equipmentSchema = z.object({
    ...
    recall_number: z.string()
        .min(1, "Recall number is required")
        .max(255, "Recall number must be less than 255 characters"),
    ...
    status: z.enum(['active', 'inactive', 'pending_calibration', 'in_calibration', 'retired'])
        .optional()
        .default('active'),
    ...
    if (data.last_calibration_date && data.next_calibration_due &&
        data.last_calibration_date !== '' && data.next_calibration_due !== '') {
...
export const employeeEquipmentRequestSchema = z.object({
    recallNumber: z.string()
        ...
        .max(255, "Recall number must be less than 255 characters"),
    description: z.string()
        .min(1, "Equipment description is required"),
